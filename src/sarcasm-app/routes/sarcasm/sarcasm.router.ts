...
sarcasmRouter
    .route<SarcasmRoute>('/')
    .get(...attachDatabase(sarcasmController.getRandomSarcasm));
sarcasmRouter
    .route<SarcasmRoute>('/sarcasm/all')
    .get(...attachDatabase(sarcasmController.getAllSarcasm));
sarcasmRouter
    .route<SarcasmRoute>('/sarcasm/random')
    .get(...attachDatabase(sarcasmController.getRandomSarcasm));
